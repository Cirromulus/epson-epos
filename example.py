...
images = {
    "sd_8" : Printer.Image("cat.png", resolution=Printer.Image.SD_8),
    "dd_8" : Printer.Image("cat.png", resolution=Printer.Image.DD_8),
    "sd_24" : Printer.Image("cat.png", resolution=Printer.Image.SD_24),
    "dd_24" : Printer.Image("cat.png", resolution=Printer.Image.DD_24),
}
